...
function boxtitleToEquation(arrBox:string[], isLeft: boolean){
...
function getEquationTitleFromArr(arr: any[], isTop: boolean) : string[]{
    let result:string[] = [];
...
function splitPlusMinus(arr: {}, isMin?: boolean): any[] {
    let arrPlus = [];
    let arrMin= [];
...
export function getEquation(arr: {}){
    ...
    const firstEqPlus = boxtitleToEquation(getEquationTitleFromArr(findTopPlus, true), true)
    const secondEqPlus = boxtitleToEquation(getEquationTitleFromArr(findLeftPlus, false), false)
    ...
    const firstEqMinus = boxtitleToEquation(getEquationTitleFromArr(findTopMinus, true), true)
    const secondEqMinus = boxtitleToEquation(getEquationTitleFromArr(findLeftMinus, false), false)
